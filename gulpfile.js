...
gulp.task ('sass', function () {
  return  gulp.src ('./src/scss/angular-ui-range-slider.scss')
          .pipe (plumber())
          .pipe (sassGlob())
...
gulp.task ('sass:production', function () {
    return  gulp.src ('./src/scss/angular-ui-range-sliderscss')
            .pipe (rename('angular-ui-range-slider.min.css'))
            .pipe (plumber())
            .pipe (sassGlob())
            .pipe (sass().on('error', sass.logError))
...
gulp.task ('js', function () {
  return  gulp.src ('./src/**/*.js')
          ...
          .pipe (concat('angular-ui-range-slider.js'))
          .pipe (gulp.dest('./dist/'));
});
...
gulp.task ('js:production', function () {
    return  gulp.src ('./src/**/*.js')
            ...
            .pipe (ngAnnotate().on('error', gutil.log))
            .pipe (angularFilesort())
            .pipe (concat('angular-ui-range-slider.min.js'))
